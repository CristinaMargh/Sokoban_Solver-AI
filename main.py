...
if __name__ == "__main__":
    crt_map = Map.from_yaml("tests/easy_map2.yaml")
    ...
    path_states = beam_search_solver(
        crt_map,
        beam_width=60,      
        timeout=600,         # secunde maximale (None = nelimitat)
...
# ==========================================================
    ...
    start_map_lrta = Map.from_yaml("tests/easy_map2.yaml")   # hartă proaspătă
    start_time = time.time()
